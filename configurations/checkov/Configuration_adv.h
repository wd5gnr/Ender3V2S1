...
#define FWRETRACT  // MRiscoC Enabled support for firmware based retract
  ...
  #endif
  #define RETRACT_LENGTH                5   // (mm) Default retract length (positive value)  // Bowden
  #define RETRACT_LENGTH_SWAP          13   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             13   // (mm/s) Default feedrate for retracting
  #define RETRACT_ZRAISE                0.2   // (mm) Default retract Z-raise  // MRiscoC Bowden
  #define RETRACT_RECOVER_LENGTH        0   // (mm) Default additional recover length (added to retract length on recover)
  #define RETRACT_RECOVER_LENGTH_SWAP   0   // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
  #define RETRACT_RECOVER_FEEDRATE      13   // (mm/s) Default feedrate for recovering from retraction
