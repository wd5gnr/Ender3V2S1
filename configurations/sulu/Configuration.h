...
#define PIDTEMPBED  // Ender Configs
  ...
  #define DEFAULT_bedKp 112.83
  #define DEFAULT_bedKi  21.05
  #define DEFAULT_bedKd 403.18
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, -9.3, 0 }
...
#define X_BED_SIZE 230  // Max usable bed size
#define Y_BED_SIZE 230  // Max usable bed size

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -5  // Stock physical limit
#define Y_MIN_POS 3  // Stock physical limit
#define Z_MIN_POS 0
#define X_MAX_POS 241  // Stock physical limit
#define Y_MAX_POS 234  // Stock physical limit
...
#define FILAMENT_RUNOUT_SENSOR  // MRiscoC Enabled runout sensor support
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 7  // Customizable by menu
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 30              // Set Mesh bounds as an inset region of the bed  // Center mesh
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 1), (Y_MAX_POS - 1), 20 }
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 50  // Ender Configs
#define LCD_FEEDBACK_FREQUENCY_HZ 800  // Ender Configs
